...
2. Filter to café venues.
3. Remove permanently closed venues; keep temporarily closed ones, flagged.
4. Remove duplicate venues.
5. Flag "popular" cafés: rating >= 4.2 AND reviews >= 100.
6. Validate and save.
...
# Provisional popularity thresholds
...
def validate(cafes: pd.DataFrame) -> None:
    """Assert the cleaning produced a well-formed dataset."""
